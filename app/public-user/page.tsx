      ...
      <aside className="w-full lg:w-80 backdrop-blur-3xl bg-[#0a2814]/60 border-r border-white/10 flex flex-col p-5 sm:p-8 shrink-0 z-10 text-white shadow-2xl relative">
        <div className="flex-1">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-[10px] font-black text-emerald-400/60 mt-1 uppercase tracking-[0.3em]">
          ...
          <div className="bg-white/5 rounded-2xl p-5 mb-10 border border-white/5 backdrop-blur-sm group hover:bg-white/10 transition-colors">
            ...
            <p className="text-slate-100 font-bold truncate text-sm">
              {user?.email}
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-6 mb-8 sm:mb-12">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] font-black text-emerald-700 uppercase tracking-[0.4em]">
                Activity Monitor
              </span>
            </div>
            ...
            <p className="text-slate-500 mt-2 font-medium tracking-wide">
              Manage and track your active environment service tickets
            </p>
          </div>
          {tickets.length > 0 && (
            <button
        ...
        <div className="min-h-[600px] pb-20">
          {loading && tickets.length === 0 ? (
            <div className="py-40 flex flex-col items-center justify-center">
              ...
              <p className="mt-6 text-[10px] font-black text-emerald-800 uppercase tracking-[0.5em]">
                Syncing Data
              </p>
            </div>
          ) : (
            <MyBookingsList
              ...
              onRatingSuccess={() => {
                // refresh tickets or update state after a rating is submitted
                fetchTickets(); // or whatever your data-fetching function is called
              }}
            />
          )}
        </div>
